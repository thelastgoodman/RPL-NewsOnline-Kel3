			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					   <form  enctype= "multipart/form-data"  action="{{url('404')}}" method="post" name="daftar">
                        ...
                        <div class="form-group">
                                <label for="exampleInputEmail1">Username <font color="red" >* <p id='pesan_error_nl'></p></font></label>
                                <input type="username" class="form-control"  placeholder="Username" name="NL" id="nl"> 
                          </div>
