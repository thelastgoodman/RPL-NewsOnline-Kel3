        ...
        <div class="content_bottom_left">
          <div class="single_page_area">
            ...
            <div class="single_page_content">
              ...
              <p>Jumlah Komentar :<b>12</b>
              <div class="col-md-12">
              		<form action="#">
              			<div class="form-group">
              				<textarea class="form-control"  rows="10" cols="50" placeholder="Masukan Komentar" name="NL" id="nl"></textarea>
              			</div>

  <button type="submit" class="btn btn-primary" width="40px" onclick="return validasi()">Komentari</button>
